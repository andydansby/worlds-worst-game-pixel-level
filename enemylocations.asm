...
;;pointer address = $f800
	;;------------------------------
	defb  11	;;number of enemies		enemies_per_level
;;------------------------------
...
defb    05,		        03,	             30,         3, 		    bob,        03,     $aa,    02;2
defb    06,		        04,	             40,         4, 		    bob,        04,     $aa,    03;3
defb    07,		        05,	             50,         5, 		    bob,        05,     $aa,    04;4
defb    08,		        06,	             60,         5, 		    bob,        05,     $aa,    05;5
